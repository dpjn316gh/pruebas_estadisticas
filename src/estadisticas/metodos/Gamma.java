...
/**
 * Provides methods associated with the gamma distribution. Provides two static
 * functions, one for calculating the inverse chi-squared distribution and one
 * for calculating the rate for different rate categories under a gamma
 * distribution.
 *
 * @author Daniel Money
 * @version 2.0
